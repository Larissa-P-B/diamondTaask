...
import br.com.fiap.diamondTaask.task.dto.TaskUpdateRequest;
...
public class TaskService {
    ...
    public Page<Task> findAll(Pageable pageable) {
        return taskRepository.findAll(PageRequest.of(pageable.getPageNumber(), pageable.getPageSize(),
                Sort.by(Sort.Direction.ASC, "prioridade")));
    }
    ...
    public Task update(UUID id, TaskUpdateRequest task) {
    ...
    public Task create(Task task) {
        ...
        task.setPrazo(calcularPrazo(task.getDataEntrega()));
    ...
    private Integer calcularPrazo(LocalDateTime dataEntrega) {
        return (int) ChronoUnit.DAYS.between(LocalDateTime.now(), dataEntrega);
    }
}
